...
model_path="$path_prefix/5_NorthAmerica_prediction_outputs_250m_v92/2_RF/Prediction_models/2007"
...
for biweek in ${biweeks[@]}; do
  python 4.1.1_RF_train.py -t "$train_path/northamerica_train_v92_250m_70pct_2007_$biweek.csv" -m "$model_path/$biweek/"
done
