...
for region in ${regions[@]}; do
  file_name="northamerica_rf_v92_250m_output_sm_2022_14_region_$region.csv"
  python 4.1.2_RF_predict.py -m "$model_path/14/" -e "$eval_path/14/northamerica_eval_v92_250m_region_${region}_2022_14.csv" -o "$output_path/14/$file_name"
done
