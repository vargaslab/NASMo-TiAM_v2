...
for region in ${regions[@]}; do
  file_name="northamerica_rf_v92_250m_output_sm_2022_11_region_$region.csv"
  python 4.1.2_RF_predict.py -m "$model_path/11/" -e "$eval_path/11/northamerica_eval_v92_250m_region_${region}_2022_11.csv" -o "$output_path/11/$file_name"
done
