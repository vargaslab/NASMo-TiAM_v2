...
for region in ${regions[@]}; do
  file_name="northamerica_rf_v92_250m_output_sm_2022_13_region_$region.csv"
  python 4.1.2_RF_predict.py -m "$model_path/13/" -e "$eval_path/13/northamerica_eval_v92_250m_region_${region}_2022_13.csv" -o "$output_path/13/$file_name"
done
